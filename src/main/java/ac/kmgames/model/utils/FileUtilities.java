...
import ac.kmgames.Exception.FileException;
...
public class FileUtilities {
     ...
     * @param gamePost
     */
    public static List<GamePhoto> parseFileInfo(List<MultipartFile> multipartFiles, GamePost gamePost) throws Exception {
        ...
        List<GamePhoto> fileList = new ArrayList<>();
        ...
        for (MultipartFile multipartFile : multipartFiles) {
            ...
            GamePhoto gamePhoto = new GamePhoto(gamePost,
                    multipartFile.getOriginalFilename(),
                    filename,
                    filePath,
                    multipartFile.getSize());

            fileList.add(gamePhoto);
     ...
     * @param gamePhoto
     */
    public static File getDownloadFile(GamePhoto gamePhoto) {

        return new File(Paths.get(rootPath, "files").toString(), gamePhoto.getFileName());
    }
