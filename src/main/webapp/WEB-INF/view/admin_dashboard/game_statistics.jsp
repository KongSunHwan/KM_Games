            ...
            <div class="container-fluid mt-15">
                    ...
                    <div class="col">
                        <div class="card mb-15">
                            <div class="card-body">
                                ...
                                <h3 class="mb-10">189,909,000 원</h3>
                                <p class="text-muted mb-0">이전달: 100,802,000 원
                                    <span class="float-right"> <i class="fas fa-angle-up text-success"></i> 46.9%</span>
                                </p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        ...
                        <div class="card mb-15">
                            <div class="card-header bg-transparent py-15">개요</div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="card mb-15">
                            <div class="card-header bg-transparent py-15">게임 Top 5 인기 순위</div>
                ...
                <div class="row">
                                ...
                                <table class="table text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-primary">구매 완료</span>
                                        </td>
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="card mb-15">
                            <div class="card-header bg-transparent py-15">관리자 멤버</div>
                                ...
                                <div class="mb-15">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <h6 class="my-3">정성진</h6>
                                            <small class="text-muted">Jeong***@gmail.com</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-15">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <h6 class="my-3">공선환</h6>
                                            <small class="text-muted">Kong***@gmail.com</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-15">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <h6 class="my-3">김재호</h6>
                                            <small class="text-muted">Kim***@gmail.com</small>
                                        </div>
                                    </div>
                                </div>
