...
<body>
  <div class="story1">
    ...
    <div class="navbar">
      <div class="logo">
        <img src="resources/img/KM_GAMES_logo2.png" />
      </div>
    ...
    <div class="member">
      ...
      <div class="member4">
        <form action="#" method="post">
          ...
          <input id="input4" type="button" value="회원가입" />
  ...
  <section id="popular--alg" class="courses slider">
    <div class="container">
                ...
                <div class="card course-card">
                  <a href="#" class="course-card--front">
                    <div class="card-image">
                      <img src="resources/img/game/game_img.png" alt="image">
                    </div>
                    <div class="card-detail">
                      <div class="course-title" style="color:gray;">슈팅 게임</div>
                      <div class="course-instructor" style="color:black"><b>Coding Works</b></div>
                      <div class="course-rating">
                        <div class="rating-stars" style="color:#ffD700">
                          <svg aria-hidden="true" data-prefix="fas" data-icon="star"
                            class="svg-inline--fa fa-star fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 576 512" width="16" height="16" data-value="1">
  ...
  <div class="cta-section text-center py-5 position-relative bg-gradient">
    ...
    <div class="container">
      ...
      <div class="pt-3 text-center">
        <a class="btn btn-light" href="#">게임 보러가기 <i class="fas fa-arrow-alt-circle-right ml-2"></i></a>
      </div>
    </div>
  </div>
