                ...
                <c:forEach var="i" begin="0" end="1">
                    <div class="row" style="margin-top:10px;">
                        <c:forEach var="j" begin="0" end="3">
                            <div class="card-back mb-2 col-lg-3" style="cursor:pointer;" onclick="location.href = '/game_detail'">
                                <div class="card-img">
                                ...
                                <div class="card-text2">
                                    <b style="font-size: 17px;"><%=new java.util.Random().nextInt(100) + 1%>,000원</b>
                                </div>
                                <div class="card-text2">
                                    &#x2B50&#x2B50&#x2B50&#x2B50&#x2B50 (48)
                                </div>
                                <div class="card-under">
                                    <span class="badge bg-secondary text-white" style="margin-top:10px;">좋아요 +<%=new java.util.Random().nextInt(10) + 1%></span>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
